...
const menu = {
  "ШАУРМА": [
    ...
    { id: 6, name: "Шаурма в тандыре", price: 180, desc: "В хрустящей булочке тандыра" },
    { id: 7, name: "Шаурма мексиканская (с халапенью)", price: 230, desc: "Острее обычной, с халапенью" }
  ],
  "ШАУРМА В КЛЯРЕ": [
